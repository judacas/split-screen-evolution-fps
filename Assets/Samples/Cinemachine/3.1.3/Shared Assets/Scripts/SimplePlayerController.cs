...
namespace Unity.Cinemachine.Samples
{
    ...
    /// </summary>
    public abstract class SimplePlayerControllerBase
        : MonoBehaviour,
    ...
    public class SimplePlayerController : SimplePlayerControllerBase
    {
        ...
        [Tooltip(
            "Makes the player strafe when moving sideways, otherwise it turns to face the direction of motion."
        )]
        ...
        void ApplyMotion()
        {
            if (m_Controller != null)
                m_Controller.Move(
                    (m_CurrentVelocityY * UpDirection + m_CurrentVelocityXZ) * Time.deltaTime
                );
            else
            {
